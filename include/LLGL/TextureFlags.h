...
struct TextureDescriptor
{
    ...
    */
    ...
    \remarks This is required for multi-planar formats (see IsMultiPlanarFormat). If a sampler is bound together with this texture, it must have an equal conversion (see BindFlags::SamplerYcbcrConversion).
